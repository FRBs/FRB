...
from resample_DM_2 import DM_kde_rand_100, DM_kde_rand_1000, var_by_dm_100, var_by_dm_1000
...
plt.ylabel('PDF')
plt.tight_layout()
plt.savefig('bootstrap_outputs/DEFT/variances_plot_100_cropped.png')
plt.show()
...
plt.ylabel('PDF')
plt.tight_layout()
plt.savefig('bootstrap_outputs/DEFT/variances_plot_1000_cropped.png')
plt.show()
