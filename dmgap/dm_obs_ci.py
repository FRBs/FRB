...
plt.plot(grid_psr,gap_95_optimal,color='blue',label=r'DM$_\mathrm{Gap}$ (CI=95%)',linewidth=1)
plt.plot(grid_psr,gap_96_optimal,color='red',label=r'DM$_\mathrm{Gap}$ (CI=96%)',linewidth=1)
plt.plot(grid_psr,gap_98_optimal,color='darkgreen',label=r'DM$_\mathrm{Gap}$ (CI=98%)',linewidth=1)
plt.hist(gap_95,density=True,histtype='stepfilled',bins=100,alpha=.2,color='blue')
plt.hist(gap_96,density=True,histtype='stepfilled',bins=100,alpha=.2,color='red')
plt.hist(gap_98,density=True,histtype='stepfilled',bins=100,alpha=.2,color='darkgreen')
