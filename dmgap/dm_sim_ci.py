...
frb_95_density_1000 = sw.DensityEstimator(frb_sim_1000_95, bounding_box=[min(frb_sim_1000_95)-20,max(frb_sim_1000_95)+20], alpha=3, num_posterior_samples=100)
...
frb_90_density_100 = sw.DensityEstimator(frb_sim_100_90, bounding_box=[min(frb_sim_100_90)-20,max(frb_sim_100_90)+20], alpha=4, num_posterior_samples=100)
...
frb_95_density_100 = sw.DensityEstimator(frb_sim_100_95, bounding_box=[min(frb_sim_100_95)-20,max(frb_sim_100_95)+20], alpha=4, num_posterior_samples=100)
...
matplotlib.rc('xtick', labelsize=10) 
matplotlib.rc('ytick', labelsize=10) 
plt.plot(dm_grid,frb_995_optimal_10000,color='blue',label=r'FRB DM CI=99.5%',linewidth=1)
plt.plot(dm_grid,frb_998_optimal_10000,color='red',label=r'FRB DM CI=99.8%',linewidth=1)
plt.plot(dm_grid,frb_999_optimal_10000,color='orange',label=r'FRB DM CI=99.9%',linewidth=1)
plt.hist(frb_sim_10000_995,density=True,histtype='stepfilled',bins=20,alpha=.2,color='blue')
plt.hist(frb_sim_10000_998,density=True,histtype='stepfilled',bins=20,alpha=.2,color='red')
plt.hist(frb_sim_10000_999,density=True,histtype='stepfilled',bins=20,alpha=.2,color='orange')
plt.axvline(x=90,linestyle='--',color='k',label='Simulated FRB cut-off')
plt.xlabel(r'DM (pc cm$^{-3}$)',fontsize=14)
plt.ylabel('PDF',fontsize=14)
plt.title('10000 Draws')
plt.legend(fontsize=14)
plt.xlim([0,220])
plt.tight_layout()
plt.savefig('sim_outputs/dm_gaps_10000.png', dpi=300)
plt.show()
