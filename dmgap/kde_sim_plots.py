...
ax1.plot(dm_grid, kde_optimal_100, color='teal',linewidth=1,label=r'$\Delta DM_{FRB}$ KDE ($n=100$)')
ax1.fill_between(dm_grid, kde_optimal_100-kde_std_100, kde_optimal_100+kde_std_100, alpha=.3,color='teal')
ax1.plot(dm_grid, deft_optimal_100, color='crimson',linewidth=1,label=r'$\Delta DM_{FRB}$ DEFT ($n=100$)')
...
ax2.plot(dm_grid, kde_optimal_1000, color='teal',linewidth=1,label=r'$\Delta DM_{FRB}$ KDE ($n=1000$)')
ax2.fill_between(dm_grid, kde_optimal_1000-kde_std_1000, kde_optimal_1000+kde_std_1000, alpha=.3,color='teal')
ax2.plot(dm_grid, deft_optimal_1000, color='crimson',linewidth=1,label=r'$\Delta DM_{FRB}$ DEFT ($n=1000$)')
...
ax3.plot(dm_grid, kde_optimal_2000, color='teal',linewidth=1,label=r'$\Delta DM_{FRB}$ KDE ($n=2000$)')
ax3.fill_between(dm_grid, kde_optimal_2000-kde_std_2000, kde_optimal_2000+kde_std_2000, alpha=.3,color='teal')
ax3.plot(dm_grid, deft_optimal_2000, color='crimson',linewidth=1,label=r'$\Delta DM_{FRB}$ DEFT ($n=2000$)')
...
ax4.plot(dm_grid, kde_optimal_4000, color='teal',linewidth=1,label=r'$\Delta DM_{FRB}$ KDE ($n=4000$)')
ax4.fill_between(dm_grid, kde_optimal_4000-kde_std_4000, kde_optimal_4000+kde_std_4000, alpha=.3,color='teal')
ax4.plot(dm_grid, deft_optimal_4000, color='crimson',linewidth=1,label=r'$\Delta DM_{FRB}$ DEFT ($n=4000$)')
