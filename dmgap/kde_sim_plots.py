...
kde_optimal_5000 = np.load('kde_and_deft_data/kde_5000_optimal.npy')
kde_optimal_10000 = np.load('kde_and_deft_data/kde_10000_optimal.npy')
...
kde_bootstrapped_5000 = np.load('kde_and_deft_data/kde_5000_bootstrapped.npy')
kde_bootstrapped_10000 = np.load('kde_and_deft_data/kde_10000_bootstrapped.npy')
...
kde_std_5000 = np.load('kde_and_deft_data/kde_std_5000.npy')
kde_std_10000 = np.load('kde_and_deft_data/kde_std_10000.npy')
...
ax3.plot(dm_grid, deft_optimal_5000, color='crimson',linewidth=1,label=r'DM$_\mathrm{FRB}$ DEFT ($n=5000$)')
...
ax4.plot(dm_grid, deft_optimal_10000, color='crimson',linewidth=1,label=r'DM$_\mathrm{FRB}$ DEFT ($n=10000$)')
...
plt.tight_layout()
plt.savefig('sim_outputs/dm_kde_sim_vary_n.png', dpi=300)
plt.show()
