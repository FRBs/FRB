...
#     ax1.plot(grid_psr,deltaDM_psr_ensemble_*1000,color='#f46036',linewidth=1,alpha=.2)
...
#     ax2.plot(grid_frb,deltaDM_frb_ensemble_*100,color='crimson',linewidth=1,alpha=.2)
...
# ax2.axis(xmin=-600,xmax=5000,ymin=0)
