...
# Pulsars
deltaDM_psr_density = sw.DensityEstimator(np.array(psrcat_df['deltaDM']), bounding_box=[-200,200], alpha=alpha_param, num_posterior_samples=1000)
...
deltaDM_psr_density_2 = sw.DensityEstimator(np.array(psrcat_df['deltaDM']), bounding_box=[-200,200], alpha=alpha_param, num_posterior_samples=1000)
deltaDM_psr_optimal_nonnorm_2 = deltaDM_psr_density_2.evaluate(grid_psr)
deltaDM_psr_optimal_2 = deltaDM_psr_optimal_nonnorm_2/np.sum(deltaDM_psr_optimal_nonnorm_2) #normalise
deltaDM_psr_ensemble_nonnorm_2 = deltaDM_psr_density_2.evaluate_samples(grid_psr)

deltaDM_psr_ensemble_nonnorm = np.append(deltaDM_psr_ensemble_nonnorm,deltaDM_psr_ensemble_nonnorm_2,axis=1)
...
deltaDM_frb_density = sw.DensityEstimator(np.array(frbcat_df['deltaDM']), bounding_box=[-600,5000], alpha=alpha_param, num_posterior_samples=1000)
...
deltaDM_frb_density_2 = sw.DensityEstimator(np.array(frbcat_df['deltaDM']), bounding_box=[-600,5000], alpha=alpha_param, num_posterior_samples=1000)
deltaDM_frb_optimal_nonnorm_2 = deltaDM_frb_density_2.evaluate(grid_frb)
deltaDM_frb_optimal_2 = deltaDM_frb_optimal_nonnorm_2/np.sum(deltaDM_frb_optimal_nonnorm_2) #normalise
deltaDM_frb_ensemble_nonnorm_2 = deltaDM_frb_density_2.evaluate_samples(grid_frb)
deltaDM_frb_ensemble_nonnorm = np.append(deltaDM_frb_ensemble_nonnorm,deltaDM_frb_ensemble_nonnorm_2,axis=1)

deltaDM_frb_density_3 = sw.DensityEstimator(np.array(frbcat_df['deltaDM']), bounding_box=[-600,5000], alpha=alpha_param, num_posterior_samples=1000)
deltaDM_frb_optimal_nonnorm_3 = deltaDM_frb_density_3.evaluate(grid_frb)
deltaDM_frb_optimal_3 = deltaDM_frb_optimal_nonnorm_3/np.sum(deltaDM_frb_optimal_nonnorm_3) #normalise
deltaDM_frb_ensemble_nonnorm_3 = deltaDM_frb_density_3.evaluate_samples(grid_frb)
deltaDM_frb_ensemble_nonnorm = np.append(deltaDM_frb_ensemble_nonnorm,deltaDM_frb_ensemble_nonnorm_3,axis=1)

# deltaDM_frb_density_4 = sw.DensityEstimator(np.array(frbcat_df['deltaDM']), bounding_box=[-600,5000], alpha=alpha_param, num_posterior_samples=1000)
# deltaDM_frb_optimal_nonnorm_4 = deltaDM_frb_density_4.evaluate(grid_frb)
# deltaDM_frb_optimal_4 = deltaDM_frb_optimal_nonnorm_4/np.sum(deltaDM_frb_optimal_nonnorm_4) #normalise
# deltaDM_frb_ensemble_nonnorm_4 = deltaDM_frb_density_4.evaluate_samples(grid_frb)
# deltaDM_frb_ensemble_nonnorm = np.append(deltaDM_frb_ensemble_nonnorm,deltaDM_frb_ensemble_nonnorm_4,axis=1)
