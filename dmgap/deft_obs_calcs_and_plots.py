...
# Pulsars
dmdiff_psr_density = sw.DensityEstimator(np.array(psrcat_df['dmdiff']), bounding_box=[-200,200], alpha=alpha_param, num_posterior_samples=100) #len(psrcat_df['dmdiff'])
...
dmdiff_frb_density = sw.DensityEstimator(np.array(frbcat_df['dmdiff']), bounding_box=[0,4000], alpha=alpha_param, num_posterior_samples=100) #len(frbcat_df['dmdiff'])
