...
# ax1.plot(grid_frb,dmdiff_frb_optimal,color='darkslategrey',label=r'$\Delta DM_{FRB}$ obs')
# ax1.hist(np.array(frbcat_df['dmdiff']),density=True,histtype='stepfilled',bins=30,alpha=0.5,label=r'Observed $\Delta DM_{FRB}$',color='teal')
ax1.hist(dm_frb_sim, density=True, bins=1000, histtype='stepfilled', alpha=.2, color='black', label=r'Simulated $\Delta DM_{FRB}$')
ax1.plot(dm_grid, deft_optimal_frb_len, color='crimson',linewidth=1,label=r'$\Delta DM_{FRB}$ sim ($n=68$)')
...
ax3.plot(dm_grid, deft_optimal_2000, color='crimson',linewidth=1,label=r'$\Delta DM_{FRB}$ sim ($n=2000$)')
...
ax4.plot(dm_grid, deft_optimal_4000, color='crimson',linewidth=1,label=r'$\Delta DM_{FRB}$ sim ($n=4000$)')
