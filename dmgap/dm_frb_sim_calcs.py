...
sample_5000 = np.asarray(random.sample(list(dm_frb_sim),5000))
density_5000 = sw.DensityEstimator(sample_5000, alpha=alpha_param, bounding_box=b_box, num_posterior_samples=num_ensembles)
...
optimal_5000 = density_5000.evaluate(dm_grid)
...
sampled_5000 = density_5000.evaluate_samples(dm_grid)
...
std_5000 = []
for i in range(len(dm_grid)):
    std_5000_ = np.std(sampled_5000[i])
    std_5000 = np.append(std_5000,std_5000_)
...
np.save('sim_output_data/optimal_5000.npy',optimal_5000)
...
np.save('sim_output_data/sampled_5000.npy',sampled_5000)
...
np.save('sim_output_data/std_5000.npy',std_5000)
