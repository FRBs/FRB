...
sys.path.insert(1, '/Users/emmaplatts/Coding/DM_gap/FRB')
from frb import igm
import numpy as np
import scipy as sp
import pandas as pd
...
# plt.hist(dm_frb_sim, density=True, bins=1000, histtype='stepfilled', alpha=.2, color='black', label=r'Simulated $\Delta$DM$_\mathrm{FRB}$')
# plt.xlabel(r'DM (pc cm$^{-3}$)',fontsize=14)
# plt.ylabel('PDF',fontsize=14)
# plt.xlim(0,2000)
# plt.legend(fontsize=14)
# plt.tight_layout()
# plt.savefig('sim_output_figs/DM_FRB_z.png', dpi=300)
# plt.show()

np.save('sim_output_data/dm_frb_sim.npy', dm_frb_sim)
np.save('sim_output_data/dm_grid.npy', dm_grid)
