...
for i in range(len(frbcat_df['deltaDM'])):
...
np.save('kde_outputs/kde_100_optimal.npy',kde_optimal_100)
np.save('kde_outputs/kde_100_bootstrapped.npy',kde_100_bootstrapped)
np.save('kde_outputs/kde_std_100.npy',kde_std_100)
...
np.save('kde_outputs/kde_1000_optimal.npy',kde_optimal_1000)
np.save('kde_outputs/kde_1000_bootstrapped.npy',kde_1000_bootstrapped)
np.save('kde_outputs/kde_std_1000.npy',kde_std_1000)
...
np.save('kde_outputs/kde_2000_optimal.npy',kde_optimal_2000)
np.save('kde_outputs/kde_2000_bootstrapped.npy',kde_2000_bootstrapped)
np.save('kde_outputs/kde_std_2000.npy',kde_std_2000)
...
np.save('kde_outputs/kde_5000_optimal.npy',kde_optimal_5000)
np.save('kde_outputs/kde_5000_bootstrapped.npy',kde_5000_bootstrapped)
np.save('kde_outputs/kde_std_5000.npy',kde_std_5000)
...
np.save('kde_outputs/kde_10000_optimal.npy',kde_optimal_10000)
np.save('kde_outputs/kde_10000_bootstrapped.npy',kde_10000_bootstrapped)
np.save('kde_outputs/kde_std_10000.npy',kde_std_10000)
