...
frb190608 = frb.FRB.by_name('FRB190608')
frb190711 = frb.FRB.by_name('FRB190711')
...
def test_allprob():
    like = mcmc.all_prob(mcmc.Planck15_Obh70, 0.32, None,
                         mcmc.frb_zs)
...
outroot = os.path.join(resource_filename('frb', 'tests'), 'files')
