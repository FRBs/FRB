...
def prob_eb17(R_frb, m, R_0=0.2, R_h=0.25, ret_numgal=False):
    """
    Chance-coincidence probability of associating a galaxy with an FRB.

    Implements Eq. 2-style formalism from Eftekhari & Berger (2017).
    Returns probability, and optionally expected number of galaxies.
...
def load_host_tbl(hosts_file:str=None, host_tbl:pandas.DataFrame=None):
    """Generate a simple host table from a CSV file.
